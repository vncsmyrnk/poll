...
BEGIN
    ...
    -- 2. Distribute Votes Randomly across ALL created polls
    ...
    FOR i IN 1..50 LOOP
        ...
        -- Insert Vote
        -- Ignore conflicts if we accidentally generate same IP for same poll (rare with random IP logic above)
        BEGIN
            INSERT INTO votes (poll_id, option_id, voter_ip)
            VALUES (p_id, temp_id, voter_ip::INET);
